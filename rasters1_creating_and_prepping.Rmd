...
### compare this map to our hammerhead map, which we generated by replacing
### discrete cell values with probabilities, without smoothing - note the
### square cell edges are still visible (barely)
